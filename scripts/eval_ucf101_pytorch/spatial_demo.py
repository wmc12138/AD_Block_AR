...
def main():
    ...
    model_path = '../../checkpoints/UcNone_f0.5_1mode2_79.725.pth'
    start_frame = 0
    num_categories = 101

    model_start_time = time.time()
    params = torch.load(model_path)
    spatial_net = models.rgb_AD_origin_resnet50(pretrained=False, num_classes=101)
    ...
    val_file = "./my_spatial_testlist01_with_labels.txt"
    ...
    for line in val_list:
        ...
        clip_path = '../../../../../Datasets'+line_info[0][17:]
